REM This batch file make QGIS 2.18.x LTR portable on windows
REM config will be stored in QGIS 2.18.x/qgis/qgisconfig
REM options will be stored in QGIS 2.18.x/qgis/qgisoptions
